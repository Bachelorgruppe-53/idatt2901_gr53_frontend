  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <MaterialIcons name="star" size={24} color={Colors.brand.darkYellow} /><Text style={styles.favourite}>Favoritt yrke</Text>
      </View>
      <View style={styles.imageWrapper}>
        <Image source={require('../assets/images/profile/1.png')} style={styles.image} />
      </View>
      <Text style={styles.name}> Hei, Ola Normann!</Text>
      <Pressable style={[styles.button, !isReady && styles.buttonDisabled]} 
        onPress={() => isReady ? alert ('midlertidig alert - karrieretesten!') : null} 
        disabled={!isReady}>
        <Text style={styles.buttonText}>Ta karrieretesten</Text>
      </Pressable>
      <Pressable style={[styles.button, !isReady && styles.buttonDisabled]} 
        onPress={() => isReady ? alert ('midlertidig alert - klasse knapp!') : null} 
        disabled={!isReady}>
